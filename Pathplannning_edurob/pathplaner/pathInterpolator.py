...
def main():
    points = [[0.0, 0.0], [0.0, 1.0], [2.0, 1.0], [2.0, 0.0], [0.0, 0.0]]
    angles = [0, 0, 180, 180, 180]
    # points = [[0.0, 0.0], [0.0, 0.0]]
    # angles = [0, 180]
    #save wheel speed to file         
    csv_file = pathInterpolator(points, angles, v_trans_init= 0.1, a_trans = 0.05, v_rot_init= 0.7, a_rot=0.5 , interval = 50) #Change interval, robot speed and the vel_ramp time here

    file = open("C:/Users/Benutzer 1/Documents/PlatformIO/Projects/edurob_platformio/data/path_planner.csv", 'w')
